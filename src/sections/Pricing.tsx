...
export const Pricing = () => {
  return (
    <section id="pricing" className="bg-[#5d2cab] py-16 md:py-24">
          ...
          {pricingTiers.map(
            ({
              ...
              <div
                key={title}
                className={twMerge(
                  "border bg-white text-black border-white/20 rounded-3xl p-8 w-full lg:w-1/3",
              ...
              >
                ...
                <Button
                  className={twMerge(
                    "btn btn-primary w-full mt-[30px] py-8 text-lg font-bold rounded-xl",
                    inverse === true && "bg-white hover:bg-white/80 text-black"
                  )}
                >
                  {buttonText}
                </Button>
